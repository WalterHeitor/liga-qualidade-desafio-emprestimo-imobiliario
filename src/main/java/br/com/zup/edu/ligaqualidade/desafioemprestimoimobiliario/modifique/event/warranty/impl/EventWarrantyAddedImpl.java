...
public class EventWarrantyAddedImpl extends EventGeneric implements EventWarranty {

    private String  warrantyId;
    private String  warrantyValue;
    private String  warrantyProvince;

    public EventWarrantyAddedImpl() { }

    public EventWarrantyAddedImpl(String eventId, String eventSchema, String eventAction, String eventTimestamp, String proposalId, String warrantyId, String warrantyValue, String warrantyProvince) {
    ...
    public Event newEvent(String... info) {
        return new EventWarrantyAddedImpl(info[0], info[1], info[2], info[3], info[4], info[5], info[6], info[7]);
